...
const EditForm = (props) => {
  ...
  return (
    <Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages} style={{ height: "950px" }}>
      ...
      <Form.Item name={["property_information", "corpoate_id"]} label="Corporativos" rules={[{ required: true }]}>
        <Select
      ...
      <Form.Item name={['property_information', 'region']} label="Región" rules={[{ required: true }]}>
         <Select
      ...
      <Form.Item name={['property_information', 'park_property']} label="Propietario" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item name={['property_information', 'market']} label="Mercado" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item name={['property_information', 'industry']} label="Industria" rules={[{ required: true }]}>
      <Select
              placeholder="Selecciona la unidad de medida"
              allowClear
            >
      ...
      <Form.Item name={['property_information', 'infrastructure']} label="Infraestructura Disponible" rules={[{ required: true }]}>
        <Select
          placeholder="Select a option and change input text above"
          allowClear
          mode="multiple"
      ...
      <div style={{display:'block', width:'50%'}}>
      <Form.Item name={['property_information', 'inicio_de_operaciones']} label="Inicio de Operaciones" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item name={['property_information', 'number_employe']} label="Número de empleados" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      {/* <Form.Item name={['property_information', 'message']} label="Mensaje" rules={[{ required: true }]}>
        <Input />
      </Form.Item> */}
      <Form.Item name={['property_information', 'practices_recognition']} label="Reconocimientos mejores Prácticas" rules={[{ required: true }]}>
        <Select
          placeholder="Select a option and change input text above"
          allowClear
          mode="multiple"
      ...
      <Form.Item name={['property_information', 'superficie_disponible']} label="Superficie Disponible" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item name={['property_information', 'unity']} label="Unidad De Medida" rules={[{ required: true }]}>
        <Select
          placeholder="Selecciona la unidad de medida"
          allowClear
        >
      ...
      <Form.Item name={['property_information', 'map']} value={latlng} style={{display:'flex', justifyContent:'center', width:'100%', marginTop:'30px'}}>
        <BasicMap
